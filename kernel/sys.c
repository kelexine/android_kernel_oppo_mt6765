...
extern struct static_key_false mysufs_is_uname_spoof_buffer_set;
extern void mysufs_spoof_uname(struct new_utsname* tmp);
#endif
...
#ifdef CONFIG_MYSU_MYSUFS_SPOOF_UNAME
	if (static_branch_likely(&mysufs_is_uname_spoof_buffer_set))
		mysufs_spoof_uname(&tmp);
#endif
	up_read(&uts_sem);
