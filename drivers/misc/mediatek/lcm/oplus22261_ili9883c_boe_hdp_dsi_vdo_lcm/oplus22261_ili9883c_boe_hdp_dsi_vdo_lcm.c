...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	register_device_proc("lcd", "ili9883c_boe", "22261_boe_ili9883c");
}
...
struct LCM_DRIVER oplus22261_ili9883c_boe_hdp_dsi_vdo_lcm_drv =
{
	.name = "oplus22261_ili9883c_boe_hdp_dsi_vdo_lcm",
